...
final class OpenApiContractTest extends TestCase
{
    public function testSdkOperationManifestMatchesTheCanonicalContract(): void
    {
        ...
        $expected = ['createCheckoutSession', 'createDestination', 'createDomain', 'createWebhookEndpoint', 'createWidgetDomain', 'createWidgetSession', 'deleteDomain', 'deleteWebhookEndpoint', 'getDomain', 'getUsage', 'getWidgetDomain', 'health', 'listDestinations', 'listDomains', 'listWebhookDeliveries', 'listWebhookEndpoints', 'retryWebhookDelivery', 'updateWebhookEndpoint', 'verifyWidgetDomain'];
        sort($expected);
